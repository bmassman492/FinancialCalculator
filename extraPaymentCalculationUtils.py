...
def calculate_invest_benefit():
    global InvestBenefit, TotalAmountInvested, TotalInvestmentAccountValue, InvestmentGain, Payment1, TotalInterestOnLoan1, Payment2, TotalInterestOnLoan2, InvestmentLengthYrs, TotalInvestmentAccountValue2
